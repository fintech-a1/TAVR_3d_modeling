...
def vtk_render_gif(renderer, N, name, Roll=False, Azimuth=False, Elevation=False, Actor=None, RotateX=False,
                   RotateY=False, RotateZ=False, Zoom=0, Dolly=0, standard=True, width=default_width,
...
print(os.listdir('./008/Post Cardiac CT'))

file = './008/Pre Abdomen/3/'
# dicomReader = vtk.vtkDICOMImageReader()
# dicomReader.SetDirectoryName(file)
# dicomReader.Update()
#
